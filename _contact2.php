...
<div class="boxInput [form_class class='boxInput-cfm' step=2]">
    <div class="boxInput__items [form_class class='boxInput__items-cfm' step=2]">
        ...
        <div class="boxInput__input">
            <ul class="listInput">
                <li class="listInput__items-name ">
                    [mwform_datepicker name="c_day" class="textInput textInput-day" size="30"]<span class="boxInput__hidden [form_class class='boxInput__hidden-step2' step=2]">[mwform_hidden name="c_day_h" echo="true"][mwform_hidden name="c_reception_id"]</span>
                </li>
                <li class="listInput__items-name ">
                    <div class="btnCommon btnCommon-input [form_class class='btnCommon-hidden' step=2]" id="datepicker_reception">選択する</div>
                </li>
            </ul>
        </div>
    </div>
    <div class="boxInput__items boxInput__items-mbl [form_class class='boxInput__items-cfm' step=2]">
        ...
        <div class="boxInput__input" data-time-value="">
            <ul class="listInput">
                <li class="listInput__items-name ">
                    [form_time]<span class="boxInput__hidden [form_class class='boxInput__hidden-step2' step=2]">[mwform_hidden name="c_time_h" echo="true"][mwform_hidden name="c_time_v_h"]</span>時
                </li>
                <li class="listInput__items-name ">
                    <div class="btnCommon btnCommon-input [form_class class='btnCommon-hidden' step=2]" id="select_calendarTime">選択する</div>
                </li>
            </ul>
        </div>
    </div>
